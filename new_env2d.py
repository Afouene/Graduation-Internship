...
class AUVEnvironment(gym.Env):
    ...
    def step(self, action):
        ...
        print("for node",selection_node_wet, "this is d=",r,"this is beta",beta,"this is energy harvested",harvested_energy,"  and this is for info",self.energy_required_for_trans(r,0))
        if beta !=1:
            self.occurence[selection_node_wet] += 1
            reward += (self.AoI_max - self.AoI_all_nodes[selection_node_wet]) / self.AoI_max
